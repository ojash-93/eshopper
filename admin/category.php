                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="uploads/<?php echo $row["category_image"] ?>" width="100" />
                                                </td>


                                                <td>
                                                    <a href="updatecategory.php?id=<?php echo $row["category_id"] ?>" class="btn btn-sm btn-info">Edit</a>
                                                    <a href="?id=<?php echo $row["category_id"] ?>&imgname=<?php echo $row["category_image"] ?>" class="btn btn-sm btn-danger">delet</a>
