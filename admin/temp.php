                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    ...
                                    <?php
                                     if(isset($_GET["id"])){
                                        $id = $_GET["id"];
                                        $result = mysqli_query($conn, "delete from offer where offer_id   = '$id' ") or die(mysqli_errno($conn));
                                     }
                                    ?>
                                        <thead>
                                            <tr>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $row["disciunt"] ?> </td>
                                                <td><?php echo $row["code"] ?> </td>
                                               
                                                <td><a href="../offer.php">Details</a></td>
                                               <td> <a href="?id=<?php echo $row["offer_id"] ?>" class="btn btn-sm btn-danger">delet</a>
                                               <td> <a href="updateoffer.php?id=<?php echo $row["offer_id"] ?>" class="btn btn-sm btn-danger">update</a>
